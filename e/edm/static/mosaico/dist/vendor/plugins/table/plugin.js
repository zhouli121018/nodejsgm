                    ...
                    items: [
                        {
                            ...
                            items: (editor.settings.table_appearance_options !== false) ? [
                                ...
                                {label: '边距', name: 'cellspacing'},
                                {label: '间距', name: 'cellpadding'},
    ...
    define("tinymce/tableplugin/Plugin", [
        ...
        function Plugin(editor) {
            ...
            function insertTable(cols, rows) {
                ...
                html = '<table id="__mce" style="width: 350px; margin-left: auto; margin-right: auto;" border="1" cellspacing="1" cellpadding="0"><tbody>';
            ...
            editor.addMenuItem('cell', {
                ...
                menu: [
                    ...
                    {text: '合并单元格', onclick: cmd('mceTableMergeCells'), onPostRender: postRenderMergeCell},
                    {text: '拆分单元格', onclick: cmd('mceTableSplitCells'), onPostRender: postRenderCell}
                ]
            });
            ...
            editor.addMenuItem('row', {
                ...
                context: 'table',
                menu: [
                    {text: '上方插入行', onclick: cmd('mceTableInsertRowBefore'), onPostRender: postRenderCell},
                    {text: '下方插入行', onclick: cmd('mceTableInsertRowAfter'), onPostRender: postRenderCell},
                    ...
                    /*{text: '-'},
                     ...
                     {text: '上方粘贴行', onclick: cmd('mceTablePasteRowBefore'), onPostRender: postRenderCell},
                     {text: '下方粘贴行', onclick: cmd('mceTablePasteRowAfter'), onPostRender: postRenderCell} */
                ]
            });
            ...
            editor.addMenuItem('column', {
                ...
                context: 'table',
                menu: [
                    {text: '左侧插入列', onclick: cmd('mceTableInsertColBefore'), onPostRender: postRenderCell},
                    {text: '右侧插入列', onclick: cmd('mceTableInsertColAfter'), onPostRender: postRenderCell},
