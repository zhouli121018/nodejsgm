...
function(e, t) {
	...
	var s = {},
		...
		Ze = "tinymce/Editor",
		et = "tinymce/util/I18n",
		tt = "tinymce/FocusManager",
		nt = "tinymce/EditorManager",
		rt = "tinymce/LegacyInput",
		it = "tinymce/util/XHR",
		ot = "tinymce/util/JSON",
		at = "tinymce/util/JSONRequest",
		st = "tinymce/util/JSONP",
		lt = "tinymce/util/LocalStorage",
		ct = "tinymce/Compat",
		ut = "tinymce/ui/Layout",
		dt = "tinymce/ui/AbsoluteLayout",
		ft = "tinymce/ui/Button",
		ht = "tinymce/ui/ButtonGroup",
		pt = "tinymce/ui/Checkbox",
		mt = "tinymce/ui/ComboBox",
		gt = "tinymce/ui/ColorBox",
		vt = "tinymce/ui/PanelButton",
		yt = "tinymce/ui/ColorButton",
		bt = "tinymce/util/Color",
		Ct = "tinymce/ui/ColorPicker",
		xt = "tinymce/ui/Path",
		wt = "tinymce/ui/ElementPath",
		Nt = "tinymce/ui/FormItem",
		Et = "tinymce/ui/Form",
		_t = "tinymce/ui/FieldSet",
		St = "tinymce/ui/FilePicker",
		kt = "tinymce/ui/FitLayout",
		Tt = "tinymce/ui/FlexLayout",
		Rt = "tinymce/ui/FlowLayout",
		At = "tinymce/ui/FormatControls",
		Bt = "tinymce/ui/GridLayout",
		Dt = "tinymce/ui/Iframe",
		Lt = "tinymce/ui/InfoBox",
		Mt = "tinymce/ui/Label",
		Pt = "tinymce/ui/Toolbar",
		Ht = "tinymce/ui/MenuBar",
		Ot = "tinymce/ui/MenuButton",
		It = "tinymce/ui/MenuItem",
		Ft = "tinymce/ui/Throbber",
		zt = "tinymce/ui/Menu",
		Ut = "tinymce/ui/ListBox",
		Wt = "tinymce/ui/Radio",
		Vt = "tinymce/ui/ResizeHandle",
		$t = "tinymce/ui/SelectBox",
		qt = "tinymce/ui/Slider",
		jt = "tinymce/ui/Spacer",
		Yt = "tinymce/ui/SplitButton",
		Xt = "tinymce/ui/StackLayout",
		Kt = "tinymce/ui/TabPanel",
	...
	r(l, [], function() {
		...
		function s() {
			...
			c = l + (+new Date).toString(32), d = "onmouseenter" in document.documentElement, u = "onfocusin" in document.documentElement, f = {
				...
				do a = n[c], a && e(i, a), n = n.parentNode || n.ownerDocument || n.defaultView || n.parentWindow;
		...
		x = e.support = {}, E = e.isXML = function(e) {
			...
			}), P = P.length && new RegExp(P.join("|")), H = H.length && new RegExp(H.join("|")), n = ge.test(L.compareDocumentPosition), I = n || ge.test(L.contains) ?
			function(e, t) {
		...
		return function(i, a) {
			...
			function l(t) {
				...
				n = t.screenX - B, r = t.screenY - D, F = n * R[2] + P, z = r * R[3] + H, F = 5 > F ? 5 : F, z = 5 > z ? 5 : z, i = "IMG" == _.nodeName && a.settings.resize_img_proportional !== !1 ? !e.modifierPressed(t) : e.modifierPressed(t) || "IMG" == _.nodeName && R[2] * R[3] !== 0, i && ($(n) > $(r) ? (z = q(F * O), F = q(z / O)) : (F = q(z / O), z = q(F * O))), N.setStyles(S, {
					...
					top: s,
					display: "block"
				}), k.innerHTML = F + " &times; " + z, R[2] < 0 && S.clientWidth <= F && N.setStyle(S, "left", L + (P - F)), R[3] < 0 && S.clientHeight <= z && N.setStyle(S, "top", M + (H - z)), n = j.scrollWidth - Y, r = j.scrollHeight - X, n + r !== 0 && N.setStyles(k, {
					left: o - n,
					top: s - r
			...
			var N = a.dom,
				E = t.each,
				_, S, k, T, R, A, B, D, L, M, P, H, O, I, F, z, U = a.getDoc(),
				W = document,
				V = r.ie && r.ie < 11,
				$ = Math.abs,
				q = Math.round,
		...
		function c(e) {
			...
			if (d(e.container())) if (e.isAtEnd()) f = C(e.container(), e.offset()), v(f) && s(f, f.data.length), m(f) && !y(f) && i(r(n(f), !1));
			else {
		...
		return function(s) {
			...
			function $(t, n, r, i) {
				...
				function h() {
					...
					if (d) if (c) s = X.getBookmark(), e.collapse(!0), e = O(e, m(n), !0), e = K.split(e), w(n, r, e), X.moveToBookmark(s);
					else {
		...
		return function(i) {
			function o(o) {
				...
				function C(e) {
					...
					if (e || "TABLE" == z ? (n = a.create(e || W), y(n)) : n = M.cloneNode(!1), o = n, l.keep_styles !== !1) do
					if (s[t.nodeName]) {
		...
		var l = a.matchNodeNames("td th"),
			c = function(a, c) {
				...
				function f(e) {
					if (A) for (k = e.firstChild; k; k = k.walk(!0)) D[k.name] && k.attr("data-mce-new", "true")
				}
				function h() {
					if (A) {
						var e = a.getBody(),
							n = new o(M);
						t.each(M.select("*[data-mce-new]"), function(t) {
							t.removeAttribute("data-mce-new");
							for (var r = t.parentNode; r && r != e; r = r.parentNode) n.compare(r, t) && M.remove(t, !0)
						})
					}
				}
				function p(e) {
				...
				function y(t) {
					...
					if (t) {
						...
						S = M.createRng(), k = t.previousSibling, k && 3 == k.nodeType ? (S.setStart(k, k.nodeValue.length), e.ie || (T = t.nextSibling, T && 3 == T.nodeType && (k.appendData(T.data), T.parentNode.removeChild(T)))) : (S.setStartBefore(t), S.setEndBefore(t)), c = M.getParent(t, M.isBlock), M.remove(t), c && M.isEmpty(c) && (a.$(c).empty(), S.setStart(c, 0), S.setEnd(c, 0), l(c) || g(c) || !(u = o(S)) ? M.add(c, M.create("br", {
							"data-mce-bogus": "1"
						})) : (S = u, M.remove(c))), L.setRng(S)
					}
				}
				var b, C, x, w, N, E, _, S, k, T, R, A, B, D = a.schema.getTextInlineElements(),
					L = a.selection,
					M = a.dom;
				"string" != typeof c && (A = c.merge, B = c.data, c = c.content), /^ | $/.test(c) && (c = u(c)), b = a.parser, C = new n({
					validate: a.settings.validate
				}, a.schema), R = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>', E = {
					content: c,
					format: "html",
					selection: !0
				}, a.fire("BeforeSetContent", E), c = E.content, -1 == c.indexOf("{$caret}") && (c += "{$caret}"), c = c.replace(/\{\$caret\}/, R), S = L.getRng();
				var P = S.startContainer || (S.parentElement ? S.parentElement() : null),
					H = a.getBody();
				P === H && L.isCollapsed() && M.isBlock(H.firstChild) && v(H.firstChild) && M.isEmpty(H.firstChild) && (S = M.createRng(), S.setStart(H.firstChild, 0), S.setEnd(H.firstChild, 0), L.setRng(S)), L.isCollapsed() || (a.selection.setRng(a.selection.getRng()), a.getDoc().execCommand("Delete", !1, null), d()), x = L.getNode();
				var O = {
					context: x.nodeName.toLowerCase(),
					data: B
				};
				if (N = b.parse(c, O), s.isListFragment(N) && s.isParentBlockLi(M, x)) return S = s.insertAtCaret(C, M, a.selection.getRng(), N), a.selection.setRng(S), void a.fire("SetContent", E);
				if (p(N), f(N), k = N.lastChild, "mce_marker" == k.attr("id")) for (_ = k, k = k.prev; k; k = k.walk(!0)) if (3 == k.type || !M.isBlock(k.name)) {
				...
				if (a._selectionOverrides.showBlockCaretContainer(x), O.invalid) {
					for (L.setContent(R), x = L.getNode(), w = a.getBody(), 9 == x.nodeType ? x = k = w : k = x; k !== w;) x = k, k = k.parentNode;
					c = x == w ? w.innerHTML : M.getOuterHTML(x), c = C.serialize(b.parse(c.replace(/<span (id="mce_marker"|id=mce_marker).+?<\/span>/i, function() {
						return C.serialize(N)
					}))), x == w ? M.setHTML(w, c) : M.setOuterHTML(x, c)
				} else c = C.serialize(N), k = x.firstChild, T = x.lastChild, !k || k === T && "BR" === k.nodeName ? M.setHTML(x, c) : L.setContent(c);
				h(), y(M.get("mce_marker")), m(a.getBody()), a.fire("SetContent", E), a.addVisual()
			};
		return {
			insertAtCaret: c
		}
	...
	}), r(Oe, [I, T, y, He, A, C, d, m, u, k], function(e, t, n, r, i, o, a, s, l, c) {
		return function(u) {
			function d(e, t) {
				try {
			...
			var K = s.each,
				...
				le = oe ? "Text" : "URL";
			return R(), y(), a.windowsPhone || O(), ae && (v(), C(), N(), D(), $(), S(), q(), a.iOS ? (F(), z(), V()) : b()), oe && a.ie < 11 && (x(), _(), k(), T(), L(), M(), P(), H()), a.ie >= 11 && (z(), S()), a.ie && (b(), W(), j()), ie && (x(), w(), E(), A(), B(), I(), U(), S()), {
		...
		function y(c) {
			...
			function H(e, t, n) {
				...
				if (p = _(n), r = L(e, n), i = t(Z, a.isAboveLine(1), r), o = h.filter(i, a.isLine(1)), c = h.last(r.getClientRects()), E(r) && (p = r.getNode()), N(r) && (p = r.getNode(!0)), !c) return null;
			...
			function j(e, t, n) {
				var r, i, o;
				return !n.collapsed && (r = _(n), x(r)) ? V($(r)) : (i = L(e, n), t(i) ? V($(i.getNode(-1 == e))) : (o = -1 == e ? ee.prev(i) : ee.next(i), t(o) ? -1 === e ? q(e, i, o) : q(e, o, i) : void 0))
			}
			function Y() {
				function e(e, t) {
					var n = t(k());
				...
				c.on("mousedown", function(e) {
					...
					if (t = r(e.target)) x(t) ? (e.preventDefault(), G(A(t))) : (J(), i(e.clientX, e.clientY, c.selection.getRng()) || c.selection.placeCaretAt(e.clientX, e.clientY));
						...
						J(), re.hide();
						var n = s.closestCaret(Z, e.clientX, e.clientY);
						n && (M(e.target, n.node) || (e.preventDefault(), c.getBody().focus(), S(R(1, n.node, n.before))))
					}
		...
		var b = f.curry,
			...
			_ = c.getSelectedNode;
		return y
	}), r(Ze, [w, g, E, R, A, H, P, Y, J, Q, Z, ee, oe, ae, N, f, Ae, Pe, B, L, Oe, d, m, u, Ie, Fe, ze, je, Qe], function(e, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v, y, b, C, x, w, N, E, _, S, k, T, R) {
		function A(e, t, i) {
			var o = this,
				a, s, l;
		...
		return A.prototype = {
			...
			init: function() {
				...
				}, B.setAttrib(y, "src", u || 'javascript:""'), t.contentAreaContainer = l.iframeContainer, t.iframeElement = y, s = B.add(l.iframeContainer, y), W) try {
					t.getDoc()
				} catch (b) {
					s.src = u = v
				}
			...
			focus: function(e) {
				...
				if (!e) {
					...
					if (i || (w.opera || n.getBody().focus(), n.getWin().focus()), U || i) {
						if (l.setActive) try {
							l.setActive()
						} catch (u) {
							l.focus()
			...
			hide: function() {
				var e = this,
					t = e.getDoc();
				e.hidden || (W && t && !e.inline && t.execCommand("SelectAll"), e.save(), e.inline ? (e.getBody().contentEditable = !1, e == e.editorManager.focusedEditor && (e.editorManager.focusedEditor = null)) : (B.hide(e.getContainer()), B.setStyle(e.id, "display", e.orgDisplay)), e.hidden = !0, e.fire("hide"))
			},
			isHidden: function() {
				return !!this.hidden
			},
			...
			remove: function() {
				var e = this;
				e.removed || (e.save(), e.removed = 1, e.unbindAllNativeEvents(), e.hasHiddenInput && B.remove(e.getElement().nextSibling), e.inline || (W && 10 > W && e.getDoc().execCommand("SelectAll", !1, null), B.setStyle(e.id, "display", e.orgDisplay), e.getBody().onload = null), e.fire("remove"), e.editorManager.remove(e), B.remove(e.getContainer()), e._selectionOverrides.destroy(), e.editorUpload.destroy(), e.destroy())
			},
			destroy: function(e) {
				var t = this,
					n;
	...
	}), r(nt, [Ze, g, w, ae, d, m, c, ue, et, tt], function(e, t, n, r, i, o, a, s, l, c) {
		function u(e) {
	...
	}), r(ct, [w, f, N, E, m, d], function(e, t, n, r, i, o) {
	...
	}), r(mt, [De, be, pe, g], function(e, t, n, r) {
		return e.extend({
			init: function(e) {
				var t = this;
		...
		var t = Math.min,
			...
			r = Math.round;
		return e
	}), r(Ct, [De, we, pe, bt], function(e, t, n, r) {
		return e.extend({
			Defaults: {
	...
	}), r(At, [ye, De, ke, m, nt, d], function(e, t, n, r, i, o) {
		function a(e) {
			function t(t, n) {
				return function() {
					var r = this;
			...
			u = i(), s({
				...
				var n = [],
					i = r(e.settings.block_formats || "段落=p;Heading 1=h1;Heading 2=h2;Heading 3=h3;Heading 4=h4;Heading 5=h5;Heading 6=h6;Preformatted=pre");
				...
				var n = "楷体=KaiTi;Andale Mono=andale mono,monospace;Arial=arial,helvetica,sans-serif;Arial Black=arial black,sans-serif;Book Antiqua=book antiqua,palatino,serif;Comic Sans MS=comic sans ms,sans-serif;Courier New=courier new,courier,monospace;Georgia=georgia,palatino,serif;Helvetica=helvetica,arial,sans-serif;Impact=impact,sans-serif;Symbol=symbol;Tahoma=tahoma,arial,helvetica,sans-serif;Terminal=terminal,monaco,monospace;Times New Roman=times new roman,times,serif;Trebuchet MS=trebuchet ms,geneva,sans-serif;Verdana=verdana,geneva,sans-serif;Webdings=webdings;Wingdings=wingdings,zapf dingbats",
					i = [],
				...
				var n = [],
					r = "8pt 10pt 12pt 14pt 16pt 18pt 24pt 30pt 36pt",
		...
		return i
	}), r(It, [De, be, d, u], function(e, t, n, r) {
		return e.extend({
			Defaults: {
				border: 0,
				role: "menuitem"
	...
	}), r(zt, [ke, It, Ft, m], function(e, t, n, r) {
		return e.extend({
			Defaults: {
	...
	}), a([l, c, u, d, f, h, m, g, v, y, C, w, N, E, T, A, B, D, L, M, P, H, I, F, j, Y, J, Q, oe, ae, se, le, ue, fe, he, ve, ye, be, Ce, xe, we, Ne, Ee, _e, Se, ke, Te, Re, Ae, Be, De, Le, Me, Pe, Ie, ze, Ze, et, tt, nt, it, ot, at, st, lt, ct, ut, dt, ft, ht, pt, mt, gt, vt, yt, bt, Ct, xt, wt, Nt, Et, _t, St, kt, Tt, Rt, At, Bt, Dt, Lt, Mt, Pt, Ht, Ot, It, Ft, zt, Ut, Wt, Vt, $t, qt, jt, Yt, Xt, Kt, Gt])
}(this);