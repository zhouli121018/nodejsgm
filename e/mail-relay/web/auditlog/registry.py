...
class AuditlogModelRegistry(object):
    ...
    def register(self, model=None, include_fields=[], exclude_fields=[], mapping_fields={}, relate_field=None):
        """
    ...
    def get_model_fields(self, model):
        return {
            ...
            'relate_field': self._registry[model]['relate_field'],
        }
