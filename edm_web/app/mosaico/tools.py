...
class VersafixSettings(object):
    TEMPLATE_DATA = {
        ...
        'footerBlock': {'backgroundColor': None,
                        ...
                        'disiscrivitiText1': u'请点击这里退订',
                        'disiscrivitiText2': u'Please click here to unsubscribe',
                        'disiscrivitiText3': u'체크아웃 해주세요.',
                        'disiscrivitiText4': u'ここをクリックして払い戻しをお願いします',
                        'id': 'ko_footerBlock_2',
                        'preheaderLinkOption1': 't1',
                        ...
                        'longText1': u"如果您不想再收到此类邮件,",
                        'longText2': u"If you don't want to receive this kind of email again,",
                        'longText3': u"이 메일을 다시 받지 않으려면...,",
                        'longText4': u"もしこのようなメールを受け取りたくないなら,",
        ...
        'preheaderBlock': {'backgroundColor': None,
                           ...
                           'unsubscribeText1': u'退订',
                           'unsubscribeText2': u'unsubscribe',
                           'unsubscribeText3': u'해제',
        ...
        'theme': {'contentTheme': {'backgroundColor': '#ffffff',
                                   ...
                                   'buttonStyle': {'buttonColor': '#bfbfbf',
                                                   ...
                                                   'size': '13',
                                                   'type': 'buttonStyle'},
                                   'externalBackgroundColor': '#f7f7f7',
                                   ...
                                   'titleTextStyle': {'color': '#3f3f3f',
                                                      ...
                                                      'type': 'textStyle'},
                                   'type': 'contentTheme'},
                  'frameTheme': {'backgroundColor': '#F7F7F7',
