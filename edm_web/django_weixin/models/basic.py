...
class AccessToken(models.Model):
    corpid = models.CharField(default=settings.MP_WX_APPID, max_length=200)
    corpsecret = models.CharField(default=settings.MP_WX_APPSECRET, max_length=200)
    token = models.CharField(default=settings.MP_WX_TOKEN, max_length=1000)
    aeskey = models.CharField(default=settings.MP_WX_AESKEY, max_length=1000)
    ...
    def get_access_token(self):
        ...
        if timedel.total_seconds() > 2 * 60 * 60 or self.accesstoken == "":
            url = 'https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=' + settings.MP_WX_APPID + '&secret=' + settings.APP_SECRET
