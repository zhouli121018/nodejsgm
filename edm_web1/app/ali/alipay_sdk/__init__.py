...
class AliPay():
    ...
    def user_info_auth(self, state="login"):
        data = {
    ...
    def app_oauth_token(self, auth_code):
        data = {
    ...
    def system_oauth_token(self, auth_code):
        data = {
    ...
    def user_info_share(self, auth_token):
        data = {
    ...
    def zhima_credit_score(self, auth_token, transaction_id, cert_no, min_score=630):
        data = {
