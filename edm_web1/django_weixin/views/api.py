...
from django_weixin.models import AccessToken
                ...
                "sub_button": [
                    {
                        "type": "view",
                        "name": "必应",
                        "url": "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx78d3f61147d5747c&redirect_uri=http%3a%2f%2fcn.bing.com%2f&response_type=code&scope=snsapi_base#wechat_redirect"
                    },
                    {
                        "type": "view",
                        "name": "预约服务",
