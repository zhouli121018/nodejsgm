...
PROXIES=[]
# PROXIES.extend(
#     [{ "http": "http://211.159.69.{}:88".format(i), "https": "http://211.159.69.{}:88".format(i), } for i in range(2, 255)]
# )

# PROXIES.extend(
#     [{ "http": "http://211.159.64.{}:88".format(i), "https": "http://211.159.64.{}:88".format(i), } for i in range(2, 255)]
# )
PROXIES.extend(
    [{ "http": "http://211.159.65.{}:88".format(i), "https": "http://211.159.65.{}:88".format(i), } for i in range(2, 255)]
)
PROXIES.extend(
    [{ "http": "http://211.159.66.{}:88".format(i), "https": "http://211.159.66.{}:88".format(i), } for i in range(2, 255)]
)
